...
const ProgramStats = () => {
  ...
  >
    ...
    <Box sx={{ ml: 'auto', mb: 3 }}> {/* 'ml: auto' to push the toggle button to the right */}
      ...
      {Toggle === 'GPA' && <BarChart data={averageGPAData} yAxisLabel="Average GPA" title="Average GPA by program" yScaleMin={0} yScaleMax={100} showYTicks = {true} isMarksData = {true}/>}
      {Toggle === 'MARKS' && <BarChart data={averageMarksData} yAxisLabel="Average Marks" title="Average Marks by program" yScaleMin={0} yScaleMax={100} showYTicks = {true} isMarksData = {true}/>}
